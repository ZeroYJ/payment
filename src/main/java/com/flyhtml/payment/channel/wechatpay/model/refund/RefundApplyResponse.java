...
import com.flyhtml.payment.channel.wechatpay.serializer.FeeTypeDeserializer;
...
public class RefundApplyResponse implements Serializable {
    ...
    public String toString() {
        return "RefundResponse{" + "deviceInfo='" + deviceInfo + '\'' + ", nonceStr='" + nonceStr + '\''
               + ", transactionId='" + transactionId + '\'' + ", outTradeNo='" + outTradeNo + '\'' + ", outRefundNo='"
               + outRefundNo + '\'' + ", refundId='" + refundId + '\'' + ", channel=" + channel + ", refundFee="
               + refundFee + ", totalFee=" + totalFee + ", feeType=" + feeType + ", cashFee=" + cashFee
               + ", cashRefundFee=" + cashRefundFee + ", couponRefundFee=" + couponRefundFee + ", couponRefundCount="
               + couponRefundCount + ", couponRefundId=" + couponRefundId + '}';
    }
}
