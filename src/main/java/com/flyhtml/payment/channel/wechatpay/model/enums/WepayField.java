...
public final class WepayField {
  ...
  @Optional public static final String DEVICE_INFO = "device_info";
  ...
  /** 商品名称明细列表 */
  @Optional public static final String DETAIL = "detail";

  /** 附加数据 在查询API和支付通知中原样返回，该字段主要用于商户携带订单的自定义数据 */
  @Optional public static final String ATTACH = "attach";

  /** 商户订单号 商户系统内部的订单号,32个字符内、可包含字母 */
  public static final String OUT_TRADE_NO = "out_trade_no";

  /** 货币类型 符合ISO 4217标准的三位字母代码，默认人民币：CNY，其他值列表详见 */
  @Optional public static final String FEE_TYPE = "fee_type";
  ...
  @Optional public static final String TIME_EXPIRE = "time_expire";

  /** 商品标记，代金券或立减优惠功能的参数 */
  @Optional public static final String GOODS_TAG = "goods_tag";
  ...
  @Optional public static final String LIMIT_PAY = "limit_pay";
