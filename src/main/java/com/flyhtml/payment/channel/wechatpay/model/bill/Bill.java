...
public class Bill implements Serializable {
    ...
    public String toString() {
        return "Bill{" + "tradeTime='" + tradeTime + '\'' + ", appId='" + appId + '\'' + ", mchId='" + mchId + '\''
               + ", subMchId='" + subMchId + '\'' + ", deviceInfo='" + deviceInfo + '\'' + ", transactionId='"
               + transactionId + '\'' + ", outTradeNo='" + outTradeNo + '\'' + ", openId='" + openId + '\''
               + ", tradeType=" + tradeType + ", tradeState='" + tradeState + '\'' + ", bankType='" + bankType + '\''
               + ", feeType=" + feeType + ", totalFee=" + totalFee + ", enterRedPkgFee=" + enterRedPkgFee + ", body='"
               + body + '\'' + ", dataPkg='" + dataPkg + '\'' + ", commissionFee=" + commissionFee + ", feeRate='"
               + feeRate + '\'' + '}';
    }
}
