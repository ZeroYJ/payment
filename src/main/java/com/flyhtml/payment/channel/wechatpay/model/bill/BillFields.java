...
public final class BillFields {
     ...
     * 账单公用起始字段
     */
    private static final List<String> START_FIELDS = Arrays.asList(WepayField.TRADE_TIME, WepayField.APP_ID,
                                                                   WepayField.MCH_ID, WepayField.SUB_MCH_ID,
                                                                   WepayField.DEVICE_INFO, WepayField.TRANSACTION_ID,
                                                                   WepayField.OUT_TRADE_NO, WepayField.OPEN_ID,
                                                                   WepayField.TRADE_TYPE, WepayField.TRADE_STATE,
                                                                   WepayField.BANK_TYPE, WepayField.FEE_TYPE,
                                                                   WepayField.TOTAL_FEE, WepayField.ENTER_RED_PKG_FEE);

    private static final List<String> END_FIELDS   = Arrays.asList(WepayField.BODY, WepayField.DATA_PKG,
                                                                   WepayField.COMMISSION_FEE, WepayField.FEE_RATE);
     ...
     */
    public static final List<String>  COUNT        = Arrays.asList(WepayField.TRADE_TOTAL_COUNT,
                                                                   WepayField.TRADE_TOTAL_FEE,
                                                                   WepayField.REFUND_TOTAL_FEE,
                                                                   WepayField.COUPON_REFUND_TOTAL_FEE,
