...
public final class BillFields {
  ...
  /** 账单公用起始字段 */
  private static final List<String> START_FIELDS =
      Arrays.asList(
          WepayField.TRADE_TIME, WepayField.APP_ID,
  ...
  private static final List<String> END_FIELDS =
      Arrays.asList(
          WepayField.BODY, WepayField.DATA_PKG,
  ...
  public static final List<String> COUNT =
      Arrays.asList(
          WepayField.TRADE_TOTAL_COUNT,
