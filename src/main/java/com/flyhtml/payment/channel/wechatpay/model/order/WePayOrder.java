package com.flyhtml.payment.channel.wechatpay.model.order;
...
public class WePayOrder implements Serializable {
    ...
    public String toString() {
        return "WePayOrder{" + "openId='" + openId + '\'' + ", subscribe=" + subscribe + ", tradeType=" + tradeType
               + ", bankType='" + bankType + '\'' + ", totalFee=" + totalFee + ", feeType=" + feeType
               + ", transactionId='" + transactionId + '\'' + ", outTradeNo='" + outTradeNo + '\'' + ", attach='"
               + attach + '\'' + ", timeEnd=" + timeEnd + ", tradeState=" + tradeState + ", tradeStateDesc='"
               + tradeStateDesc + '\'' + ", cachFee=" + cachFee + ", cashFeeType=" + cashFeeType + ", deviceInfo='"
               + deviceInfo + '\'' + ", couponFee=" + couponFee + ", couponCount=" + couponCount + ", coupons="
               + coupons + '}';
    }
