...
public final class Alipay {
  ...
  private void initConfig() {
    ...
    queryConfig.put(AlipayField.PARTNER.field(), merchantId);
    queryConfig.put(AlipayField.INPUT_CHARSET.field(), inputCharset);
  }
  ...
  private void initComponents() {
    ...
    components.put(Orders.class.getSimpleName(), new Orders(this));
  }
  ...
  public Orders orders() {
    return (Orders) components.get(Orders.class.getSimpleName());
  }
