package com.flyhtml.payment.channel.alibaba.core;
...
import com.flyhtml.payment.channel.alibaba.exception.AliPayException;
import com.flyhtml.payment.channel.alibaba.model.enums.AlipayField;
import com.flyhtml.payment.channel.alibaba.model.enums.Service;
import com.flyhtml.payment.channel.alibaba.model.enums.SignType;
import com.flyhtml.payment.channel.alibaba.model.pay.AppPayDetail;
import com.flyhtml.payment.channel.alibaba.model.pay.PayDetail;
import com.flyhtml.payment.channel.alibaba.model.pay.WapPayDetail;
import com.flyhtml.payment.channel.alibaba.model.pay.WebPayDetail;
...
public class Pays extends Component {
    ...
    private String buildPayForm(Map<String, String> payParams) {
        ...
        form.append("<form id=\"pay_form\" name=\"pay_form\"").append(" action=\""
                                                                      + Alipay.GATEWAY).append(AlipayField.INPUT_CHARSET
                                                                                               + "=").append(alipay.inputCharset).append("\" method=\"POST\">");
