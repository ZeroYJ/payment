package com.flyhtml.payment.channel.alibaba.model.pay;

import com.flyhtml.payment.channel.alibaba.annotation.Optional;
...
public class WapPayDetail extends PayDetail {
    ...
    public String toString() {
        return "WapPayFields{" + "showUrl='" + showUrl + '\'' + ", externToken='" + externToken + '\'' + ", otherFee='"
               + otherFee + '\'' + ", airTicket='" + airTicket + '\'' + ", rnCheck='" + rnCheck + '\''
               + ", buyerCertNo='" + buyerCertNo + '\'' + ", buyerRealName='" + buyerRealName + '\'' + ", scene='"
               + scene + '\'' + "} " + super.toString();
    }
}
